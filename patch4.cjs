...
const techCutTop = `        {/* Modern Tech Angular Cut */}
...
const techCutBottom = `        {/* Modern Tech Angular Cut */}
        <div className="absolute top-0 left-0 w-full overflow-hidden leading-[0] z-10 pointer-events-none">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none" className="relative block w-full h-[30px] md:h-[60px]">
...
const oldWaveTop = `        {/* Soft SVG Wave Transition from White to Dark */}
        <div className="absolute top-0 left-0 w-full overflow-hidden leading-[0] z-10 pointer-events-none">
...
const oldWaveBottom = `        {/* Soft SVG Wave Transition from Dark to White */}
        <div className="absolute top-0 left-0 w-full overflow-hidden leading-[0] z-10 pointer-events-none">
          <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none" className="relative block w-full h-[60px] md:h-[100px]">
...
content = content.replace(oldWaveTop, techCutTop);
content = content.replace(oldWaveBottom, techCutBottom);
